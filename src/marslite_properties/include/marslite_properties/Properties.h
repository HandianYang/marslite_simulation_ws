 ...
 * @date 2024
 * 
 * @brief The header file for all properties related to marslite robots.
 * @note `Properties.h` is part of `marslite_simulation_ws`.
 * 
...
#ifndef MARSLITE_PROPERTIES_H_
#define MARSLITE_PROPERTIES_H_
...
#endif // #define MARSLITE_PROPERTIES_H_